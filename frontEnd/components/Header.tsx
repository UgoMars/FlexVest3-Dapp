...
function DesktopNavigation(
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-2xl font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur   ">
...
export function Header() {
  ...
  return (
    <>
      <header
        className="pointer-events-none relative z-50 flex flex-col bg-[#a02279] "
        style={{
        ...
        >
          ...
          >
            <div className="relative flex gap-4 mt-6 ">
              <h1 className="font-bold text-4xl text-white">FlexVest3</h1>
